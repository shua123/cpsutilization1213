...
var MapsLib = {
  ...
  schoolsTableId:     "1u-nF7FACEmDr9SN2Mm26Td5-UcP1p3ee0wwlV78",  
  networksTableId:    "1AvscUymyht-8qSrDrcoAgfMQHV7ClHZtiO726Sc",

  //schools:            new google.maps.FusionTablesLayer(schoolsTableId),
  ...
  query: function(selectColumns, whereClause, callback) {
    ...
    queryStr.push(" FROM " + MapsLib.networksTableId);
...
getList: function(whereClause) {
  var selectColumns = "'name', 'Underutilized'";
